...
def perform_closing(input_folder, output_folder, kernel_size):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(('.JPG', '.png', '.jpeg','.tif')):
            ...
            closed_image = cv2.dilate(closed_image, kernel, iterations=1)
...
# Example usage:
input_folder = r'H:\SEM 6\DIP\THEORY\ASSIGNMENT-2\Assignment-2-20240424T142035Z-001\output\thresholded'  # Replace with your input folder path
output_folder = r'H:\SEM 6\DIP\THEORY\ASSIGNMENT-2\Assignment-2-20240424T142035Z-001\output\morph'  # Replace with your output folder path
